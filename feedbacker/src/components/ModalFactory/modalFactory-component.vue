<template>
  <teleport to='body'>
    <div v-if="state.isActive"
      class="fixed top-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50"
...
const ModalLogin = defineAsyncComponent(() => import('../ModalLogin/modalLogin-component.vue'))
const ModalCreateAccount = defineAsyncComponent(() => import('../ModalAccountCreate/modalCreateAccount-component.vue'))
